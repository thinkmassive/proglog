...
curl -X GET http://localhost:8080 -d '{"record":{"offset":0}}'
curl -X GET http://localhost:8080 -d '{"record":{"offset":1}}'
curl -X GET http://localhost:8080 -d '{"record":{"offset":2}}'
curl -X GET http://localhost:8080 -d '{"record":{"offset":3}}'
